...
const Login = () => {
    ...
    // Login API from Reqres.in is limited to particular user email i.e eve.holt@reqres.in,
    // and it can login with any password, Please check the response for the same in postman or thunderclient.
    async function loginUser(data) {
        ...
        if (statusCode === 200) {
            ...
            setMessage(
                <div className='text-center font-medium'>Login Failed!</div>
            );
        }
    }
    ...
    return (
        <div className='flex flex-col items-center justify-center bg-gray-100 h-screen'>
            ...
            <form onSubmit={handleSubmit(loginUser)} className='flex flex-col mt-4 w-3/4 lg:w-1/3'>
                <input
